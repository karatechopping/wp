	...
	class acf_pro {
		...
		*/
		...
		public function register_assets() {
			...
			// Register scripts.
			wp_register_script( 'acf-pro-input', "{$my_theme}assets/build/js/pro/acf-pro-input{$min}.js?".time() , array( 'acf-input' ), $version );
			wp_register_script( 'acf-pro-field-group', "{$my_theme}assets/build/js/pro/acf-pro-field-group{$min}.js?".time() , array( 'acf-field-group' ), $version );
			wp_register_script( 'acf-pro-ui-options-page', "{$my_theme}assets/build/js/pro/acf-pro-ui-options-page{$min}.js?".time() , array( 'acf-input' ), $version );

			// Register styles.
			wp_register_style( 'acf-pro-input', "{$my_theme}assets/build/css/pro/acf-pro-input.css?".time() , array( 'acf-input' ), $version );
			wp_register_style( 'acf-pro-field-group', "{$my_theme}assets/build/css/pro/acf-pro-field-group.css?".time() , array( 'acf-input' ), $version );
		}
