		...
		*/
		...
		function input_admin_enqueue_scripts() {
			...
			if ( $major == 4 ) {
				...
				$script  = "{$my_theme}assets/inc/select2/4/select2.full{$min}.js?".time() ;
				$style   = "{$my_theme}assets/inc/select2/4/select2{$min}.css?".time() ;
				...
				$version = '3.5.2';
				$my_theme = get_template_directory_uri().'/npm/advanced-custom-fields-pro/';
				$script  = "{$my_theme}assets/inc/select2/3/select2{$min}.js?".time() ;
				$style   = "{$my_theme}assets/inc/select2/3/select2.css?".time() ;
