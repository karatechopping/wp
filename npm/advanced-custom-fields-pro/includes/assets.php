...
if ( ! class_exists( 'ACF_Assets' ) ) :
	...
	class ACF_Assets {
		...
		public function register_scripts() {
			...
			// Register scripts.
			wp_register_script( 'acf', "{$my_theme}assets/build/js/acf" . $suffix . '.js', array( 'jquery' ), $version );
			wp_register_script( 'acf-input', "{$my_theme}assets/build/js/acf-input" . $suffix . '.js', array( 'jquery', 'jquery-ui-sortable', 'jquery-ui-resizable', 'acf' ), $version );
			wp_register_script( 'acf-field-group', "{$my_theme}assets/build/js/acf-field-group" . $suffix . '.js', array( 'acf-input' ), $version );
			wp_register_script( 'acf-internal-post-type', "{$my_theme}assets/build/js/acf-internal-post-type" . $suffix . '.js', array( 'acf-input' ), $version );

			// Register styles.
			wp_register_style( 'acf-global', "{$my_theme}assets/build/css/acf-global.css", array( 'dashicons' ), $version );
			wp_register_style( 'acf-input', "{$my_theme}assets/build/css/acf-input.css", array( 'acf-global' ), $version );
			wp_register_style( 'acf-field-group', "{$my_theme}assets/build/css/acf-field-group.css", array( 'acf-input' ), $version );
