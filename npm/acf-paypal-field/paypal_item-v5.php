...
class acf_field_paypal_item extends acf_field {
    ...
    */
    ...
    function input_admin_enqueue_scripts() {
        ...
        // register & include JS
        wp_register_script( 'acf-input-paypal_item', $my_theme."/npm/acf-paypal-field/js/input.js" );
        wp_enqueue_script('acf-input-paypal_item');
        
        
        // register & include CSS
        wp_register_style( 'acf-input-paypal_item', $my_theme."/npm/acf-paypal-field/css/input.css" ); 
